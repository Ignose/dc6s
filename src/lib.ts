...
// Leave buffer mana behind for combat and stuff
// 750 is a conservative buffer for test buffing and various in-run use
export function libramFishBrickoFights(buffer = 750): void {
...
export function locko(): void {
    if (!get("_photocopyUsed") && !have($item`photocopied monster`)) {
        ...
        const wantlist = [
            ...
            $monster`reanimated bat skeleton`,
            $monster`reanimated serpent skeleton`,
            $monster`reanimated baboon skeleton`,
            $monster`reanimated wyrm skeleton`,
            $monster`reanimated demon skeleton`,
            $monster`reanimated giant spider skeleton`,
            ...
            $monster`scout seal`,
            $monster`bulwark bull seal`,
            $monster`official seal`,
